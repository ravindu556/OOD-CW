...
import java.util.*;
    ...
    public class CSVHandler {
        ...
        private static final String FILE_NAME = "participants_sample.csv";
        ...
        public static List<Participant> loadParticipants() {
            ...
            try (BufferedReader br = new BufferedReader(new FileReader(FILE_NAME))) {
                ...
                System.out.println("participants_sample.csv not found – will create new one when saving.");
            } catch (Exception e) {
        ...
        public static void saveAllParticipants(List<Participant> participants) {
            try (PrintWriter writer = new PrintWriter(new FileWriter(FILE_NAME))) {
                ...
                System.out.println("All participants saved to " + FILE_NAME);
            } catch (Exception e) {
